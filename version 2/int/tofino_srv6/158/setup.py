...
#方向一从182-->188,最后一跳，只执行转发
#ipv6转发  table_add ipv6_lpm_normal_end ipv6_forward ::152/128 => 00:00:00:00:00:03 2
#获取ipv6表
ipv6_lpm_normal_end = p4.Ingress.ipv6_lpm_normal_end
#插入表项
ipv6_lpm_normal_end.add_with_ipv6_forward(dst_addr = 0x00000158000000000000000000000000, dstmacaddr= 0x6cec5a3b963e, port = 152);

#方向二从188-->182
#获取srv6选路表
select_srv6_path = p4.Ingress.select_srv6_path
#插入路径
select_srv6_path.add_with_srv6_insert(dst_addr="21.158.182.2", trafficclass = 2, num_segments= 3, last_entry=2,
s1 = 0x00000258000000000000000000000000,
s2 = 0x00000257000000000000000000000000, 
s3 = 0x00000256000000000000000000000000,
...
#插入表项
ipv6_lpm_normal_start.add_with_ipv6_forward(dst_addr = 0x00000258000000000000000000000000, dstmacaddr= 0x6cec5a3b963d, port = 168);
