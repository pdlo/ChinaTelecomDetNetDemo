...
from headers_definition_5 import *
...
def main():
    ...
    probe_pkt_2 = Ether(src=get_if_hwaddr(iface), dst="ff:ff:ff:ff:ff:ff",type=TYPE_IPV6) / \
                  ...
                  srv6_list_3(segment_id="0000:0000:0000:0000:0000:0000:0000:0107") / \
                  srv6_list_4(segment_id="0000:0000:0000:0000:0000:0000:0000:0102") / \
                  srv6_list_5(segment_id="0000:0000:0000:0000:0000:0000:0000:0099") / \
                  probe_header(num_probe_data=0)
