...
select_srv6_path.add_with_srv6_insert(dst_addr="10.152.166.2", trafficclass=0x00, num_segments=0x04, last_entry=0x03, src_mac=0x000015304156, dst_mac=0x000015204182, port=156, 
