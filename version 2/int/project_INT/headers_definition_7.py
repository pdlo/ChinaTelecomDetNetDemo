...
class srv6_list_5(Packet):
    fields_desc = [IP6Field("segment_id", "::")]
class srv6_list_6(Packet):
    fields_desc = [IP6Field("segment_id", "::")]
class srv6_list_7(Packet):
    fields_desc = [IP6Field("segment_id", "::")]
...
bind_layers(srv6_list_5, srv6_list_6)
bind_layers(srv6_list_6, srv6_list_7)
bind_layers(srv6_list_7,probe_header)
