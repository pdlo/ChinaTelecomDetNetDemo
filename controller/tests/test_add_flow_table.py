...
from controller.src.app import read_db
...
SelectSrv6PathTable.add_with_srv6_insert(read_db.get_cpe_by_id(3),'10.152.166.2',6000,1,'4,3,3,2')
a=SelectTrafficClassTable.add_with_get_traffic_class(read_db.get_cpe_by_id(3),'10.152.166.2',"10.153.168.2",8000,0)
print(a)