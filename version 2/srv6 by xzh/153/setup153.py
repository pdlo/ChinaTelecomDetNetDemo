...
ipv4_lpm.add_with_ipv4_forward(dst_ipv4=0x159ebc02, src_mac=0x0a0a0a0a0a0a, dst_mac=0xa0369fd52492, port=152)

#流量等级映射
select_traffic_class = p4.Ingress.select_traffic_class
select_traffic_class.add_with_get_traffic_class(dst_ipv4=0x159cb602, src_ipv4=0x159ebc02, dst_port=80, trafficclass=0x01)


#srv6处理,插入ipv6
select_srv6_path_1 = p4.Ingress.select_srv6_path_1
select_srv6_path_1.add_with_ipv6_insert(dst_ipv4=0x159cb602, trafficclass=0x01, src_ipv6=0x00000153000000000000000000000000, dst_ipv6=0x00000152100000000000000000000000)
select_srv6_path_1.add_with_ipv6_insert(dst_ipv4=0x159cb602, trafficclass=0x00, src_ipv6=0x00000153000000000000000000000000, dst_ipv6=0x00000152000000000000000000000000)

#srv6处理,插入srv6
select_srv6_path_2 = p4.Ingress.select_srv6_path_2
select_srv6_path_2.add_with_srv6_insert(dst_ipv4=0x159cb602, trafficclass=0x01, num_segments=0x01, last_entry=0x01, 
...
select_srv6_path_2.add_with_srv6_insert(dst_ipv4=0x159cb602, trafficclass=0x00, num_segments=0x01, last_entry=0x01, 
s1=0x00000151000000000000000000000000, 
...
ipv6_lpm.add_with_ipv6_forward(dst_ipv6=0x00000152100000000000000000000000, src_mac=0x000000000153, dst_mac=0x000000152001, port=168)
