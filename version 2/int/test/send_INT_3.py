...
from headers_definition_3 import *
...
def main():
    ...
    probe_pkt_1 = Ether(src=get_if_hwaddr(iface), dst="ff:ff:ff:ff:ff:ff",type=TYPE_IPV6) / \
                  IPv6(nh=43) / \
                  srv6h(segment_left=2,last_entry=2,next_hdr=150) / \
                  srv6_list_1(segment_id="0000:0000:0000:0000:0000:0000:0000:0152") / \
                  srv6_list_2(segment_id="0000:0000:0000:0000:0000:0000:0000:0128") / \
                  srv6_list_3(segment_id="0000:0000:0000:0000:0000:0000:0000:0136") / \
