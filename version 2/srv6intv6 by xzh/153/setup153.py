...
ingress_count_srv6ipv4.add_with_ingress_count(ingress_port=168, counter_index=2)
ingress_count_srv6ipv4.add_with_ingress_count(ingress_port=128, counter_index=3)
ingress_count_srv6ipv4.add_with_ingress_count(ingress_port=184, counter_index=4)

#ipv4转发
ipv4_lpm = p4.Ingress.ipv4_lpm
ipv4_lpm.add_with_ipv4_forward(dst_ipv4=0x14140102, src_mac=0x0a0a0a0a0a0a, dst_mac=0x208810c2555f, port=152, counter_index=1)
...
ingress_count_ipv4.add_with_ingress_count(ingress_port=168, counter_index=2)
ingress_count_ipv4.add_with_ingress_count(ingress_port=128, counter_index=3)
ingress_count_ipv4.add_with_ingress_count(ingress_port=184, counter_index=4)
...
ipv6_lpm.add_with_ipv6_forward(dst_ipv6=0x00000152000000000000000000000000, src_mac=0x000000000153, dst_mac=0x000000152000, port=128, counter_index=3)
ipv6_lpm.add_with_ipv6_forward(dst_ipv6=0x00000154000000000000000000000000, src_mac=0x000000000153, dst_mac=0x000000154000, port=168, counter_index=2)
ipv6_lpm.add_with_ipv6_forward(dst_ipv6=0x00000159000000000000000000000000, src_mac=0x000000000153, dst_mac=0x000000159000, port=184, counter_index=4)
ipv6_lpm.add_with_ipv6_forward(dst_ipv6=0x00000188000000000000000000000000, src_mac=0x0a0a0a0a0a0a, dst_mac=0x208810c2555f, port=152, counter_index=1)
